...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://swahilipay-chat.lovable.app/" },
      { property: "og:site_name", content: "Swahili-paychat" },
      { property: "og:image", content: "https://swahilipay-chat.lovable.app/social-preview.jpg" },
      { property: "og:image:secure_url", content: "https://swahilipay-chat.lovable.app/social-preview.jpg" },
      { property: "og:image:type", content: "image/jpeg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Swahili-paychat — fundisha Kiswahili, ulipwe" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://swahilipay-chat.lovable.app/social-preview.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://swahilipay-chat.lovable.app/" }],
  }),
  component: Index,
});
